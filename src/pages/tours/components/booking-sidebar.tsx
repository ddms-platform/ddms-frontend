...
export default function BookingSidebar({ tourId, price }: BookingSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="my-5 h-px" style={{ backgroundColor: '#f2f2f2' }} />

      <div className="space-y-3">
        <div className="flex items-center justify-between text-sm">
          <span style={{ color: '#6a6a6a' }}>{t('tour.booking.availability')}</span>
          <span className="font-medium" style={{ color: '#34A853' }}>
            {t('tour.booking.available')}
          </span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <span style={{ color: '#6a6a6a' }}>{t('tour.booking.cancellation')}</span>
      ...
      <Link
        ...
        className="block w-full rounded-lg py-3.5 text-center text-base font-medium text-white transition-all hover:opacity-90 active:scale-[0.98]"
      ...
      <p className="mt-4 text-center text-xs" style={{ color: '#6a6a6a' }}>
