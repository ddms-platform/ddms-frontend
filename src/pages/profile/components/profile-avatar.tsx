    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="relative">
        <div
          ...
          style={{
            backgroundColor: 'var(--ddms-primary)',
        ...
        <button
          ...
          className={`absolute bottom-0 right-0 flex h-9 w-9 items-center justify-center rounded-full border transition-all hover:scale-110 ${isUploading ? 'opacity-50' : ''}`}
          style={{
